function plotPredictedDistanceVsTrueDistance()
    % close all
    ...
    times = predictorData.vec_times(2:end);
    trueUasPositions = interp1(truthData.vec_times,truthData.trix_vec_uasStates(:,1:2),times);

    measuredRgv1Positions = permute(predictorData.trix4_splineVars(end,:,1,2:end),[2,4,1,3]);
    ...
    measuredRgv2Positions = permute(predictorData.trix4_splineVars(end,:,2,2:end),[2,4,1,3]);
