function main(simParamsInput)
    ...
    rgv1 = makeRgvFromSeed(simParams.rgv1Seed, simParams.rgv1startPos, simParams.rgv1startEul, simParams.duration);
    rgv2 = makeRgvFromSeed(simParams.rgv2Seed, simParams.rgv2startPos, simParams.rgv2startEul, simParams.duration);
