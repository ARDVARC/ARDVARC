function cost = cost3D(vec_predictedRgvLocation_enu, trix_vec_sensorPointingVec_enu, trix_vec_samplePosition_enu)
    ...
    arguments(Input)
        vec_predictedRgvLocation_enu (1,3) double      % A guess of where the RGV is
    ...
    cost = sum(vecnorm(cross(trix_vec_sensorPointingVec_enu,vec_predictedRgvLocation_enu-trix_vec_samplePosition_enu,2),2,2).^2);
end