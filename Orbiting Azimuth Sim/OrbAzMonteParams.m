classdef OrbAzMonteParams
    ...
    properties
        ...
        maxOrbitDistance (1,1) double = 23;    % [m] The maximum orbit distance to test
        orbitDistanceGap (1,1) double = 0.1;   % [m] The size of the gap between each tested orbit distance
