...
cap = cv2.VideoCapture("DJI_0014_2_30_V - Copy - Trim.mp4")
frame_width = int(cap.get(3)) 
frame_height = int(cap.get(4)) 
size = (frame_width, frame_height) 
result = cv2.VideoWriter('DJI_0014R_2_30_V - Copy - Trim.avi', cv2.VideoWriter_fourcc(*'MJPG'),10, size) #XVID/MJPG
...
# Im = cv2.imread("aprilTag16H5_30.png")
